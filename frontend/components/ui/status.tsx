...
export interface StatusProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "children">,
      ...
      <div ref={ref}>
        ...
        >
          <span className="inline-flex items-center gap-2">
            {statusindicator && (
              <span
                className={cn("flex-shrink-0 rounded-full bg-white", indicatorClassName)}
                style={{
