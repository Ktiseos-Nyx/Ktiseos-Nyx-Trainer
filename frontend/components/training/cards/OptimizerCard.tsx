      ...
      <CardContent className="space-y-4">
        ...
        <SelectFormField
          ...
          options={[
            ...
            { value: 'AMUSE', label: 'AMUSE', description: 'Vendored custom optimizer (experimental)' },
            { value: 'MODA', label: 'MODA', description: 'Vendored custom optimizer (experimental)' },
            { value: 'SODA', label: 'SODA', description: 'Vendored custom optimizer (experimental)' },
