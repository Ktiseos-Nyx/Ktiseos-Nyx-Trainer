...
import { Home, Info, Github, Heart, Zap, Sparkles, ExternalLink } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <GradientCard variant="dusk" intensity="subtle">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white">About Ktiseos-Nyx</h2>
              </div>
              <div className="text-gray-300 space-y-3">
                <p>
                  <strong className="text-purple-400">Ktiseos Nyx</strong> is a space cultivated by{' '}
                  <strong className="text-white">Earth & Dusk Media</strong>, a name whispered from the echoes of{' '}
          ...
          <GradientCard variant="ocean" intensity="subtle">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white">Ktiseos-Nyx Trainer</h2>
              </div>
              <div className="text-gray-300 space-y-3">
                <p>
            ...
            <div className="p-6">
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-white">Comprehensive Training Config:</strong> 100+ parameters organized across 7 intuitive tabs</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Auto-Tagging:</strong> WD14 tagger support with 6 model variants (v2/v3 for ViT, ConvNeXT, SwinV2)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Real-time Monitoring:</strong> WebSocket-based live progress tracking during training</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Model Downloads:</strong> Built-in downloader for HuggingFace and Civitai models/VAEs</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Step Calculator:</strong> Interactive calculator with Kohya-compatible step counting</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Post-Training Utils:</strong> LoRA resizing and HuggingFace Hub upload integration</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 mt-1">•</span>
                  <span><strong className="text-white">Multi-Architecture:</strong> Supports SDXL, SD 1.5, Flux, and SD 3.5</span>
                </li>
              </ul>
            </div>
          </GradientCard>
          ...
          <GradientCard variant="cotton-candy" intensity="subtle">
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-gray-300">
                <div>
                  <h3 className="text-lg font-semibold text-pink-400 mb-2">Frontend</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-pink-400 mb-2">Backend</h3>
                  <ul className="space-y-1 text-sm">
            ...
            <div className="p-6">
              ...
              <div className="text-gray-300 space-y-3">
                ...
                <ul className="space-y-2">
                  <li><strong className="text-white">Kohya SS</strong> - For the incredible sd-scripts training framework</li>
                  <li><strong className="text-white">LyCORIS Team</strong> - For advanced LoRA architectures (LoCon, LoHa, LoKr, etc.)</li>
                  <li><strong className="text-white">SmilingWolf</strong> - For the WD14 tagger models</li>
                  <li><strong className="text-white">Derrian Distro</strong> - For the original training backend architecture</li>
                  <li><strong className="text-white">Stability AI</strong> - For Stable Diffusion</li>
                  <li><strong className="text-white">Black Forest Labs</strong> - For Flux</li>
                </ul>
                <p className="pt-3 border-t border-slate-700">
                  Built with love by a neurodivergent developer who wanted LoRA training to be
                  more accessible and less overwhelming. <span className="text-purple-400">♥</span>
                </p>
              </div>
            </div>
          </GradientCard>
          ...
          <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-lg font-semibold text-white">0.1.0 - Alpha</p>
              </div>
              <div>
              ...
              <div>
                <a
                  href="https://github.com/yourusername/ktiseos-nyx-trainer"
                  target="_blank"
          ...
          <GradientCard variant="watermelon" intensity="subtle">
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500 ml-6">
                      Backup invite: <a href="https://discord.gg/MASBKnNFWh" className="text-cyan-400 hover:underline">discord.gg/MASBKnNFWh</a>
                    </p>
                  </div>
                </div>
                ...
                {/* Support */}
                <div>
                  <h3 className="text-lg font-semibold text-purple-400 mb-3">Support Our Work</h3>
                ...
                {/* Referrals */}
                <div>
                  <h3 className="text-lg font-semibold text-purple-400 mb-3">Helpful Referral Links</h3>
                  <div className="space-y-2">
                    <a
                    ...
                    >
                      <ExternalLink className="w-4 h-4" />
                      <span>VastAI (Serverless GPU)</span>
                    </a>
                    <a
              ...
              <p className="mt-6 text-center text-purple-300 font-semibold italic">
          ...
          <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-lg p-4 text-center">
            <p className="text-gray-300">
              <span className="text-purple-400 font-semibold">Optimized for VastAI</span> -
              Deploy to cloud instances for high-performance LoRA training
            </p>
          </div>
        </div>
      </div>
